...
public class EntityData
{
    ...
    [Range(0.5f, 100.0f)] public float maxAttackRange = 1.0f;
    [Range(0.1f, 100.0f)] public float attackPerSecond = 1.0f;
    [Range(0.1f, 100.0f)] public float maxAttackPerSecond = 1.0f;
    [Range(0.1f, 100.0f)] public float moveSpeed = 3.0f;
    [Range(0.5f, 100.0f)] public float maxMoveSpeed = 3.0f;
